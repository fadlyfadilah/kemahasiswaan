    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.semesters.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('tahunangkatan') ? 'is-invalid' : '' }}" type="number" name="tahunangkatan" id="tahunangkatan" value="{{ old('tahunangkatan', '') }}" step="1" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('semester') ? 'is-invalid' : '' }}" type="text" name="semester" id="semester" value="{{ old('semester', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('frs') ? 'is-invalid' : '' }}" type="text" name="frs" id="frs" value="{{ old('frs', '') }}">
                @if($errors->has('frs'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('sks') ? 'is-invalid' : '' }}" type="number" name="sks" id="sks" value="{{ old('sks', '') }}" step="1">
                @if($errors->has('sks'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('ipsfile') ? 'is-invalid' : '' }}" type="text" name="ipsfile" id="ipsfile" value="{{ old('ipsfile', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('ips') ? 'is-invalid' : '' }}" type="text" name="ips" id="ips" value="{{ old('ips', '') }}">
                @if($errors->has('ips'))
