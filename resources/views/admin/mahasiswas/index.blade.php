                            ...
                            <tr data-entry-id="{{ $mahasiswa->id }}">
                                ...
                                <td>
                                    @can('mahasiswa_show')
                                        ...
                                        @else
                                            @if ($mahasiswa->status === 'tidakaktif')
                                                <form action="{{ route('admin.mahasiswas.status', $mahasiswa->id) }}"
                                                    method="POST"
                                                    ...
                                                    <input type="submit" class="btn btn-xs btn-success" value="Aktif">
                                                </form>
                                            @else
                                                <form action="{{ route('admin.mahasiswas.status', $mahasiswa->id) }}"
                                                    method="POST"
                                                    ...
                                                    <input type="submit" class="btn btn-xs btn-warning" value="Lulus">
                                                </form>
                                                <form action="{{ route('admin.mahasiswas.status', $mahasiswa->id) }}"
                                                    method="POST"
                                                    onsubmit="return confirm('{{ trans('global.areYouSure') }}');"
                                                    ...
                                                    <input type="submit" class="btn btn-xs btn-danger" value="Tidak Lulus">
                                                </form>
                                            @endif
                                        @endif
                                    @endcan
