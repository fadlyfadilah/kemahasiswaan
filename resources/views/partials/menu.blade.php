    ...
    <div class="sidebar">
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                @endcan
                @can('perguruan_tinggi_access')
                    <li class="nav-item">
                        <a href="{{ route("admin.perguruan-tinggis.index") }}" class="nav-link {{ request()->is("admin/perguruan-tinggis") || request()->is("admin/perguruan-tinggis/*") ? "active" : "" }}">
                            <i class="fa-fw nav-icon fas fa-hotel">

                            </i>
                            <p>
                                {{ trans('cruds.perguruanTinggi.title') }}
                            </p>
                        </a>
                    </li>
                @endcan
                ...
                @can('laporan_semester_access')
                    <li class="nav-item has-treeview {{ request()->is("admin/semesters*") ? "menu-open" : "" }}">
                        <a class="nav-link nav-dropdown-toggle {{ request()->is("admin/semesters*") ? "active" : "" }}" href="#">
